...
def get_config(nn_arch, seed):
    ...
    if nn_arch == "MLP_small":
        ...
        arch.num_layers = 5
        arch.hidden_dim = 32
        arch.fourier_emb = ml_collections.ConfigDict({"embed_scale": 2.0, "embed_dim": 32})
        ...
        arch.num_layers = 3
        arch.hidden_dim = 24
        arch.fourier_emb = ml_collections.ConfigDict({"embed_scale": 2.0, "embed_dim": 24})

    elif nn_arch == "PirateNet_med":
        arch.arch_name = "PirateNet"
        arch.num_layers = 3
        arch.hidden_dim = 48
        arch.fourier_emb = ml_collections.ConfigDict({"embed_scale": 2.0, "embed_dim": 48})

    elif nn_arch == "PirateNet_large":
        arch.arch_name = "PirateNet"
        arch.num_layers = 3
        arch.hidden_dim = 96
        arch.fourier_emb = ml_collections.ConfigDict({"embed_scale": 2.0, "embed_dim": 96})
