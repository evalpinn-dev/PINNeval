...
def get_other_config(seed=42, hidden_dim=64, num_layers=5):
    ...
    arch.fourier_emb = ml_collections.ConfigDict({"embed_scale": 1.0, "embed_dim": hidden_dim})
    arch.reparam = None
    ...
    weighting.init_weights = ml_collections.ConfigDict(
        {"u_ic": 100.0, "v_ic": 100.0, "temp_ic": 10.0, "u_bc": 100.0, "v_bc": 100.0, 
         "temp_bc": 10.0, "ru": 1.0, "rv": 1.0, "rc": 1.0, "re": 1.0}
        )
